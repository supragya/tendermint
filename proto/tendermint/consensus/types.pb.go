...
type VoteSetMaj23 struct {
	...
	AuxHeaderHash []byte              `protobuf:"bytes,5,opt,name=aux_header_hash,json=auxHeaderHash,proto3" json:"aux_header_hash,omitempty"`
}
...
func (m *VoteSetMaj23) GetAuxHeaderHash() []byte {
	if m != nil {
		return m.AuxHeaderHash
	}
	return nil
}
...
type VoteSetBits struct {
	...
	AuxHeaderHash []byte              `protobuf:"bytes,6,opt,name=aux_header_hash,json=auxHeaderHash,proto3" json:"aux_header_hash,omitempty"`
}
...
func (m *VoteSetBits) GetAuxHeaderHash() []byte {
	if m != nil {
		return m.AuxHeaderHash
	}
	return nil
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
...
func (m *VoteSetMaj23) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AuxHeaderHash) > 0 {
		i -= len(m.AuxHeaderHash)
		copy(dAtA[i:], m.AuxHeaderHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AuxHeaderHash)))
		i--
		dAtA[i] = 0x2a
	}
	{
...
func (m *VoteSetMaj23) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuxHeaderHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AuxHeaderHash = append(m.AuxHeaderHash[:0], dAtA[iNdEx:postIndex]...)
			if m.AuxHeaderHash == nil {
				m.AuxHeaderHash = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
