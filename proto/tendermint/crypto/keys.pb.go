...
type PublicKey_Eddsabn254 struct {
	Eddsabn254 []byte `protobuf:"bytes,3,opt,name=eddsabn254,proto3,oneof" json:"eddsabn254,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()    {}
func (*PublicKey_Secp256K1) isPublicKey_Sum()  {}
func (*PublicKey_Eddsabn254) isPublicKey_Sum() {}
...
func (m *PublicKey) GetEddsabn254() []byte {
	if x, ok := m.GetSum().(*PublicKey_Eddsabn254); ok {
		return x.Eddsabn254
	}
	return nil
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0xb2, 0xfa, 0x20, 0x16, 0x44, 0xa1, 0x52, 0x15, 0x17, 0x67,
	...
	0x10, 0x12, 0x52, 0xe0, 0xe2, 0x4a, 0x4d, 0x49, 0x29, 0x4e, 0x4c, 0xca, 0x33, 0x32, 0x35, 0x91,
	0x60, 0x86, 0x2a, 0x40, 0x12, 0xb3, 0xe2, 0x78, 0xb1, 0x40, 0x9e, 0xf1, 0xc5, 0x42, 0x79, 0x46,
	0x27, 0x56, 0x2e, 0xe6, 0xe2, 0xd2, 0x5c, 0xa7, 0xa0, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92,
	0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c,
	0x96, 0x63, 0x88, 0xb2, 0x48, 0xcf, 0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x47,
	0xf2, 0x27, 0x12, 0x13, 0xe2, 0x11, 0x8c, 0x30, 0x48, 0x62, 0x03, 0x4b, 0x18, 0x03, 0x02, 0x00,
	0x00, 0xff, 0xff, 0xdf, 0x98, 0x65, 0xb6, 0x1f, 0x01, 0x00, 0x00,
}
...
func (this *PublicKey_Eddsabn254) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_Eddsabn254)
	if !ok {
		that2, ok := that.(PublicKey_Eddsabn254)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.Eddsabn254, that1.Eddsabn254); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_Eddsabn254) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.Eddsabn254, that1.Eddsabn254) {
		return false
	}
	return true
}
...
func (m *PublicKey_Eddsabn254) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_Eddsabn254) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Eddsabn254 != nil {
		i -= len(m.Eddsabn254)
		copy(dAtA[i:], m.Eddsabn254)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.Eddsabn254)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_Eddsabn254) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Eddsabn254", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
